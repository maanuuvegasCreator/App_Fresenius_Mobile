...
interface ContactListProps {
  ...
  /** Lista desde API; si no se pasa, se usa la demo original. */
  contacts?: Contact[];
}
...
export function ContactList({ onCall, contacts: contactsProp }: ContactListProps) {
  const [searchQuery, setSearchQuery] = useState('');
  const source = contactsProp ?? contacts;

  const filteredContacts = source.filter(contact => 
